-- Migration: Update job_status_view to also check scanned_codes for latest_completed_operation_id
-- Date: 2025-12-21
-- Description: The view should show the latest operation from both job_operations and scanned_codes
...
-- Recreate view that checks both job_operations and scanned_codes for latest operation
